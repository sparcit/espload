...
public class KafkaSampler extends AbstractJavaSamplerClient implements Serializable {
    ...
    public Arguments getDefaultParameters() {
        ...
        defaultParameters.addArgument(SASL_KERBEROS_SERVICE_NAME, ProducerKeysHelper.SASL_KERBEROS_SERVICE_NAME_DEFAULT);
    ...
    public void setupTest(JavaSamplerContext context) {
        ...
        if (Objects.nonNull(JMeterContextService.getContext().getVariables().get(SchemaRegistryKeyHelper.SCHEMA_REGISTRY_URL))) {
            props.put(SchemaRegistryKeyHelper.SCHEMA_REGISTRY_URL, JMeterContextService.getContext().getVariables().get(SchemaRegistryKeyHelper.SCHEMA_REGISTRY_URL));
