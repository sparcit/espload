...
import uk.sparcit.espload.util.AutoCompletion;
...
//      subjectNameComboBox.addFocusListener(new ComboFiller());
  ...
  class   ComboFiller implements FocusListener {
    ...
    public void focusGained(FocusEvent e) {
      String subjects = JMeterContextService.getContext().getProperties().getProperty(SchemaRegistryKeyHelper.SCHEMA_REGISTRY_SUBJECTS);
